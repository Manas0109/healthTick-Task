...
class _timerPage2State extends State<timerPage2> with TickerProviderStateMixin {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text("Take a five-minute break to check in on your.",
              style: TextStyle(
                color: Color.fromRGBO(108, 100, 132,1),
                fontSize: 15,
              ),
            ),
            const Text("level of fullness",
              style: TextStyle(
                color: Color.fromRGBO(108, 100, 132,1),
                fontSize: 15,
              ),
